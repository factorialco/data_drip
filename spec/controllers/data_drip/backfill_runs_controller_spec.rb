...
RSpec.describe DataDrip::BackfillRunsController, type: :controller do
  ...
  describe "GET #index" do
    ...
    it "displays the configured batch_size, not the chunk actual_size" do
      get :index
      expect(response.body).to include("50")
      expect(response.body).not_to include(">10<")
    end
  end
  ...
  describe "GET #show" do
    ...
    it "displays actual_size in the batches table" do
      get :show, params: { id: backfill_run.id }
